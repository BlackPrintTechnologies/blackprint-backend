...
class UserPropertyController:
    ...
    def get_additional_property_details(self, properties, config_city=None):
        ...
        try:
            ...
            fid_col = city_manager.get_fid_column(config_city)
...
class PropertyController:
    ...
    def get_property_json(self, results, show_all_keys=True, city='mexico'):
        ...
        try:
            ...
            for result in results:
                ...
                # Handle different column structures for CDMX vs QRO using centralized city manager
                ...
                if show_all_keys:
                    ...
                    if city == 'queretaro' or city == 'el_marques':
                        ...
                        # CDMX structure (restored with safe .get() access)
                        pois = {
                            #add category here for icon image
                            "category": {
                                category: IconMapper.get_icon_url(category) 
                            ...
                            "front" : {
                                "brands_active_life_front": result.get("brands_active_life_front"),
                                "brands_arts_and_entertainment_front": result.get("brands_arts_and_entertainment_front"),
                                "brands_attractions_and_activities_front": result.get("brands_attractions_and_activities_front"),
                                "brands_automotive_front": result.get("brands_automotive_front"),
                                "brands_eat_and_drink_front": result.get("brands_eat_and_drink_front"),
                                "brands_education_front": result.get("brands_education_front"),
                                "brands_financial_service_front": result.get("brands_financial_service_front"),
                                "brands_health_and_medical_front": result.get("brands_health_and_medical_front"),
                                "brands_public_service_and_government_front": result.get("brands_public_service_and_government_front"),
                                "brands_retail_front": result.get("brands_retail_front"),
                            },
                            "500" : {
                                "brands_active_life_500m": result.get("brands_active_life_500m"),
                                "brands_arts_and_entertainment_500m": result.get("brands_arts_and_entertainment_500m"),
                                "brands_attractions_and_activities_500m": result.get("brands_attractions_and_activities_500m"),
                                "brands_automotive_500m": result.get("brands_automotive_500m"),
                                "brands_eat_and_drink_500m": result.get("brands_eat_and_drink_500m"),
                                "brands_education_500m": result.get("brands_education_500m"),
                                "brands_financial_service_500m": result.get("brands_financial_service_500m"),
                                "brands_health_and_medical_500m": result.get("brands_health_and_medical_500m"),
                                "brands_public_service_and_government_500m": result.get("brands_public_service_and_government_500m"),
                                "brands_retail_500m": result.get("brands_retail_500m"),
                            },
                            "1000" : {
                                "brands_active_life_1km": result.get("brands_active_life_1km"),
                                "brands_arts_and_entertainment_1km": result.get("brands_arts_and_entertainment_1km"),
                                "brands_attractions_and_activities_1km": result.get("brands_attractions_and_activities_1km"),
                                "brands_automotive_1km": result.get("brands_automotive_1km"),
                                "brands_eat_and_drink_1km": result.get("brands_eat_and_drink_1km"),
                                "brands_education_1km": result.get("brands_education_1km"),
                                "brands_financial_service_1km": result.get("brands_financial_service_1km"),
                                "brands_health_and_medical_1km": result.get("brands_health_and_medical_1km"),
                                "brands_public_service_and_government_1km": result.get("brands_public_service_and_government_1km"),
                                "brands_retail_1km": result.get("brands_retail_1km")
                            },  
                        }
                if show_all_keys:
                    # Handle traffic data for different cities using centralized city manager
                    if city_manager.is_qro_city(normalized_city):
                        traffic = {
                            "front": {
                        ...
                        traffic = {
                            "front": {
                                "at_rest_avg_x_hour_0_front": result.get("at_rest_avg_x_hour_0_front"),
                                "pedestrian_avg_x_hour_0_front": result.get("pedestrian_avg_x_hour_0_front"),
                                "motor_vehicle_avg_x_hour_0_front": result.get("motor_vehicle_avg_x_hour_0_front"),
                                "at_rest_avg_x_hour_1_front": result.get("at_rest_avg_x_hour_1_front"),
                                "pedestrian_avg_x_hour_1_front": result.get("pedestrian_avg_x_hour_1_front"),
                                "motor_vehicle_avg_x_hour_1_front": result.get("motor_vehicle_avg_x_hour_1_front"),
                                "at_rest_avg_x_hour_2_front": result.get("at_rest_avg_x_hour_2_front"),
                                "pedestrian_avg_x_hour_2_front": result.get("pedestrian_avg_x_hour_2_front"),
                                "motor_vehicle_avg_x_hour_2_front": result.get("motor_vehicle_avg_x_hour_2_front"),
                                "at_rest_avg_x_hour_3_front": result.get("at_rest_avg_x_hour_3_front"),
                                "pedestrian_avg_x_hour_3_front": result.get("pedestrian_avg_x_hour_3_front"),
                                "motor_vehicle_avg_x_hour_3_front": result.get("motor_vehicle_avg_x_hour_3_front"),
                                "at_rest_avg_x_hour_4_front": result.get("at_rest_avg_x_hour_4_front"),
                                "pedestrian_avg_x_hour_4_front": result.get("pedestrian_avg_x_hour_4_front"),
                                "motor_vehicle_avg_x_hour_4_front": result.get("motor_vehicle_avg_x_hour_4_front"),
                                "at_rest_avg_x_hour_5_front": result.get("at_rest_avg_x_hour_5_front"),
                                "pedestrian_avg_x_hour_5_front": result.get("pedestrian_avg_x_hour_5_front"),
                                "motor_vehicle_avg_x_hour_5_front": result.get("motor_vehicle_avg_x_hour_5_front"),
                                "at_rest_avg_x_hour_6_front": result.get("at_rest_avg_x_hour_6_front"),
                                "pedestrian_avg_x_hour_6_front": result.get("pedestrian_avg_x_hour_6_front"),
                                "motor_vehicle_avg_x_hour_6_front": result.get("motor_vehicle_avg_x_hour_6_front"),
                                "at_rest_avg_x_hour_7_front": result.get("at_rest_avg_x_hour_7_front"),
                                "pedestrian_avg_x_hour_7_front": result.get("pedestrian_avg_x_hour_7_front"),
                                "motor_vehicle_avg_x_hour_7_front": result.get("motor_vehicle_avg_x_hour_7_front"),
                                "at_rest_avg_x_hour_8_front": result.get("at_rest_avg_x_hour_8_front"),
                                "pedestrian_avg_x_hour_8_front": result.get("pedestrian_avg_x_hour_8_front"),
                                "motor_vehicle_avg_x_hour_8_front": result.get("motor_vehicle_avg_x_hour_8_front"),
                                "at_rest_avg_x_hour_9_front": result.get("at_rest_avg_x_hour_9_front"),
                                "pedestrian_avg_x_hour_9_front": result.get("pedestrian_avg_x_hour_9_front"),
                                "motor_vehicle_avg_x_hour_9_front": result.get("motor_vehicle_avg_x_hour_9_front"),
                                "at_rest_avg_x_hour_10_front": result.get("at_rest_avg_x_hour_10_front"),
                                "pedestrian_avg_x_hour_10_front": result.get("pedestrian_avg_x_hour_10_front"),
                                "motor_vehicle_avg_x_hour_10_front": result.get("motor_vehicle_avg_x_hour_10_front"),
                                "at_rest_avg_x_hour_11_front": result.get("at_rest_avg_x_hour_11_front"),
                                "pedestrian_avg_x_hour_11_front": result.get("pedestrian_avg_x_hour_11_front"),
                                "motor_vehicle_avg_x_hour_11_front": result.get("motor_vehicle_avg_x_hour_11_front"),
                                "at_rest_avg_x_hour_12_front": result.get("at_rest_avg_x_hour_12_front"),
                                "pedestrian_avg_x_hour_12_front": result.get("pedestrian_avg_x_hour_12_front"),
                                "motor_vehicle_avg_x_hour_12_front": result.get("motor_vehicle_avg_x_hour_12_front"),
                                "at_rest_avg_x_hour_13_front": result.get("at_rest_avg_x_hour_13_front"),
                                "pedestrian_avg_x_hour_13_front": result.get("pedestrian_avg_x_hour_13_front"),
                                "motor_vehicle_avg_x_hour_13_front": result.get("motor_vehicle_avg_x_hour_13_front"),
                                "at_rest_avg_x_hour_14_front": result.get("at_rest_avg_x_hour_14_front"),
                                "pedestrian_avg_x_hour_14_front": result.get("pedestrian_avg_x_hour_14_front"),
                                "motor_vehicle_avg_x_hour_14_front": result.get("motor_vehicle_avg_x_hour_14_front"),
                                "at_rest_avg_x_hour_15_front": result.get("at_rest_avg_x_hour_15_front"),
                                "pedestrian_avg_x_hour_15_front": result.get("pedestrian_avg_x_hour_15_front"),
                                "motor_vehicle_avg_x_hour_15_front": result.get("motor_vehicle_avg_x_hour_15_front"),
                                "at_rest_avg_x_hour_16_front": result.get("at_rest_avg_x_hour_16_front"),
                                "pedestrian_avg_x_hour_16_front": result.get("pedestrian_avg_x_hour_16_front"),
                                "motor_vehicle_avg_x_hour_16_front": result.get("motor_vehicle_avg_x_hour_16_front"),
                                "at_rest_avg_x_hour_17_front": result.get("at_rest_avg_x_hour_17_front"),
                                "pedestrian_avg_x_hour_17_front": result.get("pedestrian_avg_x_hour_17_front"),
                                "motor_vehicle_avg_x_hour_17_front": result.get("motor_vehicle_avg_x_hour_17_front"),
                                "at_rest_avg_x_hour_18_front": result.get("at_rest_avg_x_hour_18_front"),
                                "pedestrian_avg_x_hour_18_front": result.get("pedestrian_avg_x_hour_18_front"),
                                "motor_vehicle_avg_x_hour_18_front": result.get("motor_vehicle_avg_x_hour_18_front"),
                                "at_rest_avg_x_hour_19_front": result.get("at_rest_avg_x_hour_19_front"),
                                "pedestrian_avg_x_hour_19_front": result.get("pedestrian_avg_x_hour_19_front"),
                                "motor_vehicle_avg_x_hour_19_front": result.get("motor_vehicle_avg_x_hour_19_front"),
                                "at_rest_avg_x_hour_20_front": result.get("at_rest_avg_x_hour_20_front"),
                                "pedestrian_avg_x_hour_20_front": result.get("pedestrian_avg_x_hour_20_front"),
                                "motor_vehicle_avg_x_hour_20_front": result.get("motor_vehicle_avg_x_hour_20_front"),
                                "at_rest_avg_x_hour_21_front": result.get("at_rest_avg_x_hour_21_front"),
                                "pedestrian_avg_x_hour_21_front": result.get("pedestrian_avg_x_hour_21_front"),
                                "motor_vehicle_avg_x_hour_21_front": result.get("motor_vehicle_avg_x_hour_21_front"),
                                "at_rest_avg_x_hour_22_front": result.get("at_rest_avg_x_hour_22_front"),
                                "pedestrian_avg_x_hour_22_front": result.get("pedestrian_avg_x_hour_22_front"),
                                "motor_vehicle_avg_x_hour_22_front": result.get("motor_vehicle_avg_x_hour_22_front"),
                                "at_rest_avg_x_hour_23_front": result.get("at_rest_avg_x_hour_23_front"),
                                "pedestrian_avg_x_hour_23_front": result.get("pedestrian_avg_x_hour_23_front"),
                                "motor_vehicle_avg_x_hour_23_front": result.get("motor_vehicle_avg_x_hour_23_front"),
                                "at_rest_avg_x_day_of_week_1_front": result.get("at_rest_avg_x_day_of_week_1_front"),
                                "pedestrian_avg_x_day_of_week_1_front": result.get("pedestrian_avg_x_day_of_week_1_front"),
                                "motor_vehicle_avg_x_day_of_week_1_front": result.get("motor_vehicle_avg_x_day_of_week_1_front"),
                                "at_rest_avg_x_day_of_week_2_front": result.get("at_rest_avg_x_day_of_week_2_front"),
                                "pedestrian_avg_x_day_of_week_2_front": result.get("pedestrian_avg_x_day_of_week_2_front"),
                                "motor_vehicle_avg_x_day_of_week_2_front": result.get("motor_vehicle_avg_x_day_of_week_2_front"),
                                "at_rest_avg_x_day_of_week_3_front": result.get("at_rest_avg_x_day_of_week_3_front"),
                                "pedestrian_avg_x_day_of_week_3_front": result.get("pedestrian_avg_x_day_of_week_3_front"),
                                "motor_vehicle_avg_x_day_of_week_3_front": result.get("motor_vehicle_avg_x_day_of_week_3_front"),
                                "at_rest_avg_x_day_of_week_4_front": result.get("at_rest_avg_x_day_of_week_4_front"),
                                "pedestrian_avg_x_day_of_week_4_front": result.get("pedestrian_avg_x_day_of_week_4_front"),
                                "motor_vehicle_avg_x_day_of_week_4_front": result.get("motor_vehicle_avg_x_day_of_week_4_front"),
                                "at_rest_avg_x_day_of_week_5_front": result.get("at_rest_avg_x_day_of_week_5_front"),
                                "pedestrian_avg_x_day_of_week_5_front": result.get("pedestrian_avg_x_day_of_week_5_front"),
                                "motor_vehicle_avg_x_day_of_week_5_front": result.get("motor_vehicle_avg_x_day_of_week_5_front"),
                                "at_rest_avg_x_day_of_week_6_front": result.get("at_rest_avg_x_day_of_week_6_front"),
                                "pedestrian_avg_x_day_of_week_6_front": result.get("pedestrian_avg_x_day_of_week_6_front"),
                                "motor_vehicle_avg_x_day_of_week_6_front": result.get("motor_vehicle_avg_x_day_of_week_6_front"),
                                "at_rest_avg_x_day_of_week_7_front": result.get("at_rest_avg_x_day_of_week_7_front"),
                                "pedestrian_avg_x_day_of_week_7_front": result.get("pedestrian_avg_x_day_of_week_7_front"),
                                "motor_vehicle_avg_x_day_of_week_7_front": result.get("motor_vehicle_avg_x_day_of_week_7_front")
                            },
                            "500": {
                                "at_rest_avg_x_day_of_week_1_500m": result.get("at_rest_avg_x_day_of_week_1_500m"),
                                "pedestrian_avg_x_day_of_week_1_500m": result.get("pedestrian_avg_x_day_of_week_1_500m"),
                                "motor_vehicle_avg_x_day_of_week_1_500m": result.get("motor_vehicle_avg_x_day_of_week_1_500m"),
                                "at_rest_avg_x_day_of_week_2_500m": result.get("at_rest_avg_x_day_of_week_2_500m"),
                                "pedestrian_avg_x_day_of_week_2_500m": result.get("pedestrian_avg_x_day_of_week_2_500m"),
                                "motor_vehicle_avg_x_day_of_week_2_500m": result.get("motor_vehicle_avg_x_day_of_week_2_500m"),
                                "at_rest_avg_x_day_of_week_3_500m": result.get("at_rest_avg_x_day_of_week_3_500m"),
                                "pedestrian_avg_x_day_of_week_3_500m": result.get("pedestrian_avg_x_day_of_week_3_500m"),
                                "motor_vehicle_avg_x_day_of_week_3_500m": result.get("motor_vehicle_avg_x_day_of_week_3_500m"),
                                "at_rest_avg_x_day_of_week_4_500m": result.get("at_rest_avg_x_day_of_week_4_500m"),
                                "pedestrian_avg_x_day_of_week_4_500m": result.get("pedestrian_avg_x_day_of_week_4_500m"),
                                "motor_vehicle_avg_x_day_of_week_4_500m": result.get("motor_vehicle_avg_x_day_of_week_4_500m"),
                                "at_rest_avg_x_day_of_week_5_500m": result.get("at_rest_avg_x_day_of_week_5_500m"),
                                "pedestrian_avg_x_day_of_week_5_500m": result.get("pedestrian_avg_x_day_of_week_5_500m"),
                                "motor_vehicle_avg_x_day_of_week_5_500m": result.get("motor_vehicle_avg_x_day_of_week_5_500m"),
                                "at_rest_avg_x_day_of_week_6_500m": result.get("at_rest_avg_x_day_of_week_6_500m"),
                                "pedestrian_avg_x_day_of_week_6_500m": result.get("pedestrian_avg_x_day_of_week_6_500m"),
                                "motor_vehicle_avg_x_day_of_week_6_500m": result.get("motor_vehicle_avg_x_day_of_week_6_500m"),
                                "at_rest_avg_x_day_of_week_7_500m": result.get("at_rest_avg_x_day_of_week_7_500m"),
                                "pedestrian_avg_x_day_of_week_7_500m": result.get("pedestrian_avg_x_day_of_week_7_500m"),
                                "motor_vehicle_avg_x_day_of_week_7_500m": result.get("motor_vehicle_avg_x_day_of_week_7_500m"),
                                "at_rest_avg_x_hour_0_500m": result.get("at_rest_avg_x_hour_0_500m"),
                                "pedestrian_avg_x_hour_0_500m": result.get("pedestrian_avg_x_hour_0_500m"),
                                "motor_vehicle_avg_x_hour_0_500m": result.get("motor_vehicle_avg_x_hour_0_500m"),
                                "at_rest_avg_x_hour_1_500m": result.get("at_rest_avg_x_hour_1_500m"),
                                "pedestrian_avg_x_hour_1_500m": result.get("pedestrian_avg_x_hour_1_500m"),
                                "motor_vehicle_avg_x_hour_1_500m": result.get("motor_vehicle_avg_x_hour_1_500m"),
                                "at_rest_avg_x_hour_2_500m": result.get("at_rest_avg_x_hour_2_500m"),
                                "pedestrian_avg_x_hour_2_500m": result.get("pedestrian_avg_x_hour_2_500m"),
                                "motor_vehicle_avg_x_hour_2_500m": result.get("motor_vehicle_avg_x_hour_2_500m"),
                                "at_rest_avg_x_hour_3_500m": result.get("at_rest_avg_x_hour_3_500m"),
                                "pedestrian_avg_x_hour_3_500m": result.get("pedestrian_avg_x_hour_3_500m"),
                                "motor_vehicle_avg_x_hour_3_500m": result.get("motor_vehicle_avg_x_hour_3_500m"),
                                "at_rest_avg_x_hour_4_500m": result.get("at_rest_avg_x_hour_4_500m"),
                                "pedestrian_avg_x_hour_4_500m": result.get("pedestrian_avg_x_hour_4_500m"),
                                "motor_vehicle_avg_x_hour_4_500m": result.get("motor_vehicle_avg_x_hour_4_500m"),
                                "at_rest_avg_x_hour_5_500m": result.get("at_rest_avg_x_hour_5_500m"),
                                "pedestrian_avg_x_hour_5_500m": result.get("pedestrian_avg_x_hour_5_500m"),
                                "motor_vehicle_avg_x_hour_5_500m": result.get("motor_vehicle_avg_x_hour_5_500m"),
                                "at_rest_avg_x_hour_6_500m": result.get("at_rest_avg_x_hour_6_500m"),
                                "pedestrian_avg_x_hour_6_500m": result.get("pedestrian_avg_x_hour_6_500m"),
                                "motor_vehicle_avg_x_hour_6_500m": result.get("motor_vehicle_avg_x_hour_6_500m"),
                                "at_rest_avg_x_hour_7_500m": result.get("at_rest_avg_x_hour_7_500m"),
                                "pedestrian_avg_x_hour_7_500m": result.get("pedestrian_avg_x_hour_7_500m"),
                                "motor_vehicle_avg_x_hour_7_500m": result.get("motor_vehicle_avg_x_hour_7_500m"),
                                "at_rest_avg_x_hour_8_500m": result.get("at_rest_avg_x_hour_8_500m"),
                                "pedestrian_avg_x_hour_8_500m": result.get("pedestrian_avg_x_hour_8_500m"),
                                "motor_vehicle_avg_x_hour_8_500m": result.get("motor_vehicle_avg_x_hour_8_500m"),
                                "at_rest_avg_x_hour_9_500m": result.get("at_rest_avg_x_hour_9_500m"),
                                "pedestrian_avg_x_hour_9_500m": result.get("pedestrian_avg_x_hour_9_500m"),
                                "motor_vehicle_avg_x_hour_9_500m": result.get("motor_vehicle_avg_x_hour_9_500m"),
                                "at_rest_avg_x_hour_10_500m": result.get("at_rest_avg_x_hour_10_500m"),
                                "pedestrian_avg_x_hour_10_500m": result.get("pedestrian_avg_x_hour_10_500m"),
                                "motor_vehicle_avg_x_hour_10_500m": result.get("motor_vehicle_avg_x_hour_10_500m"),
                                "at_rest_avg_x_hour_11_500m": result.get("at_rest_avg_x_hour_11_500m"),
                                "pedestrian_avg_x_hour_11_500m": result.get("pedestrian_avg_x_hour_11_500m"),
                                "motor_vehicle_avg_x_hour_11_500m": result.get("motor_vehicle_avg_x_hour_11_500m"),
                                "at_rest_avg_x_hour_12_500m": result.get("at_rest_avg_x_hour_12_500m"),
                                "pedestrian_avg_x_hour_12_500m": result.get("pedestrian_avg_x_hour_12_500m"),
                                "motor_vehicle_avg_x_hour_12_500m": result.get("motor_vehicle_avg_x_hour_12_500m"),
                                "at_rest_avg_x_hour_13_500m": result.get("at_rest_avg_x_hour_13_500m"),
                                "pedestrian_avg_x_hour_13_500m": result.get("pedestrian_avg_x_hour_13_500m"),
                                "motor_vehicle_avg_x_hour_13_500m": result.get("motor_vehicle_avg_x_hour_13_500m"),
                                "at_rest_avg_x_hour_14_500m": result.get("at_rest_avg_x_hour_14_500m"),
                                "pedestrian_avg_x_hour_14_500m": result.get("pedestrian_avg_x_hour_14_500m"),
                                "motor_vehicle_avg_x_hour_14_500m": result.get("motor_vehicle_avg_x_hour_14_500m"),
                                "at_rest_avg_x_hour_15_500m": result.get("at_rest_avg_x_hour_15_500m"),
                                "pedestrian_avg_x_hour_15_500m": result.get("pedestrian_avg_x_hour_15_500m"),
                                "motor_vehicle_avg_x_hour_15_500m": result.get("motor_vehicle_avg_x_hour_15_500m"),
                                "at_rest_avg_x_hour_16_500m": result.get("at_rest_avg_x_hour_16_500m"),
                                "pedestrian_avg_x_hour_16_500m": result.get("pedestrian_avg_x_hour_16_500m"),
                                "motor_vehicle_avg_x_hour_16_500m": result.get("motor_vehicle_avg_x_hour_16_500m"),
                                "at_rest_avg_x_hour_17_500m": result.get("at_rest_avg_x_hour_17_500m"),
                                "pedestrian_avg_x_hour_17_500m": result.get("pedestrian_avg_x_hour_17_500m"),
                                "motor_vehicle_avg_x_hour_17_500m": result.get("motor_vehicle_avg_x_hour_17_500m"),
                                "at_rest_avg_x_hour_18_500m": result.get("at_rest_avg_x_hour_18_500m"),
                                "pedestrian_avg_x_hour_18_500m": result.get("pedestrian_avg_x_hour_18_500m"),
                                "motor_vehicle_avg_x_hour_18_500m": result.get("motor_vehicle_avg_x_hour_18_500m"),
                                "at_rest_avg_x_hour_19_500m": result.get("at_rest_avg_x_hour_19_500m"),
                                "pedestrian_avg_x_hour_19_500m": result.get("pedestrian_avg_x_hour_19_500m"),
                                "motor_vehicle_avg_x_hour_19_500m": result.get("motor_vehicle_avg_x_hour_19_500m"),
                                "at_rest_avg_x_hour_20_500m": result.get("at_rest_avg_x_hour_20_500m"),
                                "pedestrian_avg_x_hour_20_500m": result.get("pedestrian_avg_x_hour_20_500m"),
                                "motor_vehicle_avg_x_hour_20_500m": result.get("motor_vehicle_avg_x_hour_20_500m"),
                                "at_rest_avg_x_hour_21_500m": result.get("at_rest_avg_x_hour_21_500m"),
                                "pedestrian_avg_x_hour_21_500m": result.get("pedestrian_avg_x_hour_21_500m"),
                                "motor_vehicle_avg_x_hour_21_500m": result.get("motor_vehicle_avg_x_hour_21_500m"),
                                "at_rest_avg_x_hour_22_500m": result.get("at_rest_avg_x_hour_22_500m"),
                                "pedestrian_avg_x_hour_22_500m": result.get("pedestrian_avg_x_hour_22_500m"),
                                "motor_vehicle_avg_x_hour_22_500m": result.get("motor_vehicle_avg_x_hour_22_500m"),
                                "at_rest_avg_x_hour_23_500m": result.get("at_rest_avg_x_hour_23_500m"),
                                "pedestrian_avg_x_hour_23_500m": result.get("pedestrian_avg_x_hour_23_500m"),
                                "motor_vehicle_avg_x_hour_23_500m": result.get("motor_vehicle_avg_x_hour_23_500m")
                            }
                        }
                if show_all_keys:
                    resp.append( {
    ...
    def get_property_traffic(self, fid, config_city='mexico'):
        ...
        try:
            ...
            id_col = city_manager.get_fid_column(normalized_city)
            main_table = city_manager.get_main_table(normalized_city)
